...
#################################################################
x_sol, y_sol,iter, nfs, val, ng,ZZ  = secant_inv([-4.0],[-2.0],obj,dummy,dummy,max_it,prt,1,F_tol)
...
x_sol, y_sol,iter, nfs, val, ng,ZZ  = secant_inv([-4.0],[0.0],obj,dummy,dummy,max_it,prt,1,F_tol)
plot!( ZZ[1,:],ZZ[2,:], marker = (:circle, 4))
F_sol = [obj.∇xL(x_sol,y_sol); -obj.∇yL(x_sol,y_sol)]
nabla_F_sol  = obj.∇F(x_sol,y_sol);
g_sol = nabla_F_sol'*F_sol;
...
x_sol, y_sol,iter, nfs, val, ng,ZZ  = secant_inv([-2.0],[-4.0],obj,dummy,dummy,max_it,prt,1,F_tol)
...
x_sol, y_sol,iter, nfs, val, ng,ZZ  = secant_inv([0.0],[-4.0],obj,dummy,dummy,max_it,prt,1,F_tol)
plot!( ZZ[1,:],ZZ[2,:], marker = (:circle, 4))
F_sol = [obj.∇xL(x_sol,y_sol); -obj.∇yL(x_sol,y_sol)]
nabla_F_sol  = obj.∇F(x_sol,y_sol);
g_sol = nabla_F_sol'*F_sol;
...
savefig("plots/$prob_type-LS_Sec-$interaction.png")
